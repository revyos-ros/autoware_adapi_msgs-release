## autoware_adapi_msgs (jazzy) - 1.3.0-2

The packages in the `autoware_adapi_msgs` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy autoware_adapi_msgs --override-release-repository-push-url git@github.com:revyos-ros/autoware_adapi_msgs-release.git` on `Sun, 29 Sep 2024 02:56:55 -0000`
...
- release repository: https://github.com/revyos-ros/autoware_adapi_msgs-release.git
...
## autoware_adapi_msgs (humble) - 1.3.0-2

The packages in the `autoware_adapi_msgs` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble autoware_adapi_msgs --override-release-repository-push-url git@github.com:revyos-ros/autoware_adapi_msgs-release.git` on `Mon, 23 Sep 2024 05:35:38 -0000`
